package com.paddavoet.bittradr.application.security;
...
public class OAuthSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Value("${google.oauth.enabled}")
    private boolean GOOGLE_OAUTH_ENABLED;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        if (GOOGLE_OAUTH_ENABLED) {
            http
                ...
                .antMatchers("/", "/**.html", "/**.js", "js/**.js", "/user").permitAll()
